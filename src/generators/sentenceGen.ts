...
const templates: SentenceTemplate[] = [
  ...
  //    the precise one. Both blanks work together.
  {
    ...
    explanation: 'עטלף עף כמו ציפור, אבל הוא יונק: יש לו פרווה והוא מיניק את גוריו. המסיח ההפוך בודק אם קראתם את הסדר במשפט.',
  },
  {
    skill: 'general_knowledge', difficulty: 'hard',
    ...
    explanation: 'מבחינה מדעית העגבנייה היא פרי — היא מתפתחת מפרח ומכילה זרעים. שוב, המסיח המרכזי הוא הזוג ההפוך.',
  },
  {
    skill: 'general_knowledge', difficulty: 'hard',
    ...
    explanation: 'לווייתן נושם אוויר בריאות ומיניק את גוריו — לכן הוא יונק ים ולא דג.',
  },
];
